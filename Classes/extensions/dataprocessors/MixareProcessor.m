    ...
    if (![dataString isEqualToString:@""]) {
        ...
        for(NSDictionary *geoname in geonames){
            ...
            [self setData:@"lat" dataDictionary:geoname newKey:@"latitude" newDictionary:dic];
             if (geoname[@"Datainizio"] != [NSNull null] && geoname[@"Datainizio"] != nil)
            {
            [self setData:@"Datainizio" dataDictionary:geoname newKey:@"Datainizio" newDictionary:dic];
            }
            if (geoname[@"Datafine"] != [NSNull null] && geoname[@"Datafine"] != nil)
            {
            [self setData:@"Datafine" dataDictionary:geoname newKey:@"Datafine" newDictionary:dic];
            }
            if (geoname[@"Categoria"] != [NSNull null] && geoname[@"Categoria"] != nil)
            {
                [self setData:@"Categoria" dataDictionary:geoname newKey:@"Categoria" newDictionary:dic];
            }
            ...
            if (geoname[@"logo"] != [NSNull null] && geoname[@"logo"] != nil) {
                ...
                dic[keys[@"logo"]] = [[[Resources getInstance] bundle] pathForResource:@"twitter_logo" ofType:@"png"];
            }
            [ret addObject:dic];
        }
        return ret;
